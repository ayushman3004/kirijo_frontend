...
function Assam() {
  ...
  const sarees = [
    { id: 25, src: saree1, name: "ASSAM SILK", price: 3500 },
    { id: 26, src: saree2, name: "ASSAM SILK", price: 3800 },
    { id: 27, src: saree3, name: "ASSAM SILK", price: 4000 },
    { id: 28, src: saree4, name: "ASSAM SILK", price: 3600 },
    { id: 29, src: saree5, name: "ASSAM SILK", price: 3900 },
    { id: 30, src: saree6, name: "ASSAM SILK", price: 3400 },
  ];
  return (
    <>
      <Navbar />
